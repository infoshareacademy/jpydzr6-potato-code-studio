...
from .views import cover_page, about_us, contact_us, home_page, register_view, login_view, logout_view, mini_quiz_bio_view, quiz_result_view, add_product, product_list
from django.urls import path
